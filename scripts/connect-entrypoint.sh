...
DEFAULT_CONFIG_FILE="/usr/local/software/kafka/scripts/connect.default.properties"
TARGET_CONFIG_FILE="/usr/local/software/kafka/config/connect.izzy.properties"
COMMAND="CONNECT"
